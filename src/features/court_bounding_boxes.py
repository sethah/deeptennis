...
def get_court_outline(im, threshold=140, connectivity=4, sensitivity=100):
...
def get_baseline(outline, top, peak_distance=10, percentile=95):
    """
...
if __name__ == "__main__":
    ...
    for mask in mask_path.iterdir():
        ...
        for frame in tqdm(all_clip_frames):
            ...
            court_outline = get_court_outline(img, threshold=threshold, sensitivity=sensitivity)
