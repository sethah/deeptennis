...
class CourtScoreHead(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, nmaps=4):
    ...
    def forward(self, feature_maps):
        ...
        return {"court": self.out_conv_court(out), "score_class": out_score_class,
